...
import { Logo, Dropdown, QrCode } from '../../assets';
	...
	return (
		<>
			...
			<div className='bg-tickets'>
				...
				<div className='select-none grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 mb-2 mx-64'>
