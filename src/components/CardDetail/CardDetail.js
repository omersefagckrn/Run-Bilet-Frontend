...
const CardDetail = () => {
	...
	return (
		<>
			<Navbar />
			{isOpen && (
				<div className='bg-main w-full h-screen flex justify-center items-center bg-opacity-60 fixed  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 '>
					<div className='bg-whites md:w-[28rem]'>
						...
						<div className='flex items-start justify-between p-6'>
							...
							<div className='p-4 bg-primary text-whites'>
								<Link to={`/payment/${id}`}>Seçili Biletleri Al</Link>
							</div>
						</div>
					</div>
				</div>
